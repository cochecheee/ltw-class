...
<script charset="utf-8"
	src="https://platform.twitter.com/js/timeline.e108540dddc96e4b707f5cf259a582d7.js"></script>
</head>
<!-- Head END -->
...
<body class="corporate">
	...
	<div class="header">
		<div class="container">
			<a class="site-logo" href="index.html"><img
				src="${URL}assets/frontend/layout/img/logos/logo-corp-red.png"
				...
				<ul>
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="index-header-fix.html">Home with Header
									Fixed</a></li>
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 pre-footer-col">
					...
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
						...
						magna aliquarm erat sit volutpat.</p>

					<div class="photo-stream">
						<h2>Photos Stream</h2>
						<ul class="list-unstyled">
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/people/img5-small.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/works/img1.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/people/img4-large.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/works/img6.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/works/img3.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/people/img2-large.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/works/img2.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/works/img5.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/people/img5-small.jpg"></a></li>
							<li><a href="#"><img alt=""
									src="${URL}assets/frontend/pages/img/works/img1.jpg"></a></li>
				...
				<div class="col-md-4 col-sm-6 pre-footer-col">
					...
					<a class="twitter-timeline" href="https://twitter.com/twitterapi"
						...
						data-twitter-extracted-i1727313184987378265="true">Loading
	...
	<div id="topcontrol" title="Scroll Back to Top"
		...
		<img src="${URL}assets/frontend/layout/img/up.png"
