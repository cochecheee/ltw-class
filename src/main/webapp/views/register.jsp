					...
					<li class="dropdown active"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="page-forgotton-password.html">Forget
									Password</a></li>
							<li class="active"><a href="page-reg-page.html">Signup
									Page</a></li>
					...
					<div class="content-form-page">
						<div class="row">
							<div class="col-md-7 col-sm-7">
								<form class="form-horizontal" role="form" action="/ex02/register" method="post">
									<fieldset>
										<legend>Your personal details</legend>
										<div class="form-group">
											<label for="fullname" class="col-lg-4 control-label">Full Name <span class="require">*</span>
											</label>
											<div class="col-lg-8">
